...
[_QWERTY] = { /*QWERTY*/
	{KC_EQL,   KC_1,     KC_2,    KC_3,         KC_4,    KC_5,    YYYYYYY,    YYYYYYY, KC_6,    KC_7,    KC_8,         KC_9,    KC_0,    KC_BSLS},
	{KC_ESC,   KC_Q,     KC_W,    KC_E,         KC_R,    KC_T,    YYYYYYY,    YYYYYYY, KC_Y,    KC_U,    KC_I,         KC_O,    KC_P,    YYYYYYY},
	{KC_TAB,   KC_A,     KC_S, LT(RAISE, KC_D), KC_F,    KC_G,    YYYYYYY,    YYYYYYY, KC_H,    KC_J, LT(LOWER, KC_K), KC_L,    KC_SCLN, KC_QUOT},
